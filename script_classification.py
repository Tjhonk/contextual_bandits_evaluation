...
parser.add_argument( # simulation of runiiing one experiment
    '-s',
    '--sim',
    type=int,
    default=100,
...
if __name__ == '__main__':
    ...
    for sim_n in range(sim):
        ...
        config = {
            ...
            'bandit_model': bandit_model, #MOdelos adaptaivos con RidgeCV
        ...
        # estima modelos Ridge (TSModel(thompson)) 3 veces 
